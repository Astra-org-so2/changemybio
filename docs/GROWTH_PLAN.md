...
## PHASE 4 — Content ✅ готово (v0.4 код, v0.7 арт 100/100): 100 персонажей, трек «Удача», бонусы зон, арт-пайплайн
- **Цель:** удлинить LTV.
...
## PHASE 6 — Scaling 🔶 частично (v0.6): серверная валидация покупок готова (`server/`), остальное — операционные шаги
