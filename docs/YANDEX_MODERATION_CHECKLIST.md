...
## Контент
- ✅ Оригинальные персонажи/названия, арт персонажей сгенерирован для проекта (оригинальные образы, без чужих IP), emoji только как фолбэк, звуки процедурные (WebAudio) — нет чужих ассетов.
